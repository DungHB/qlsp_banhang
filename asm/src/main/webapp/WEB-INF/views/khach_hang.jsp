                ...
                <form action="/khach_hang/add" method="post">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="hoTen" name="hoTen"
                               placeholder="Nhập họ tên khách hàng" required value="${khachHang.hoTen}">
                    </div>
                    <div class="form-group">
                        <label for="diaChi">Địa Chỉ:</label>
                        <input type="text" class="form-control" id="diaChi" name="diaChi"
                               placeholder="Nhập địa chỉ khách hàng" required value="${khachHang.diaChi}">
                    </div>
                    <div class="form-group">
                        <label for="sdt">Số Điện Thoại:</label>
                        <input type="text" class="form-control" id="sdt" name="sdt" placeholder="Nhập sđt khách hàng"
                               required value="${khachHang.sdt}">
                    </div>
                        ...
                        <div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" id="active" name="trangThai"
                                       value="Active" ${khachHang.trangThai == 'Active' ? 'checked' : ''} checked>
                                <label class="form-check-label" for="active">Active</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" id="inactive" name="trangThai"
                                       value="Inactive" ${khachHang.trangThai == 'Inactive' ? 'checked' : ''}>
                    ...
                    <div class="text-center">
                        <button formaction="/khach_hang/add" type="submit" class="btn btn-success">Thêm</button>
                        <button formaction="/khach_hang/update/${khachHang.id}" type="submit" class="btn btn-success">
                            Sửa
                        </button>
                    </div>
                </form>
            ...
            <table class="table table-striped table-bordered">
                ...
                <c:forEach items="${listKH}" var="khachHang" varStatus="s">
                    <tr>
                        ...
                        <td>
                            <a href="/khach_hang/delete/${khachHang.id}" class="btn btn-danger">Delete</button>
                            </a>
                            <a href="/khach_hang/detail/${khachHang.id}" class="btn btn-info">Detail</button>
                            </a>
                        </td>
                    </tr>
                </c:forEach>
