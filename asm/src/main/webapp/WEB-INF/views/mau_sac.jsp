            ...
            <div class="card-body">
                <form action="/mau_sac/add" method="post">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="maMau" name="maMau" placeholder="Nhập mã màu sắc"
                               required value="${mauSac.maMau}">
                    </div>

                    <div class="form-group">
                        <label for="tenMau">Tên Màu Sắc:</label>
                        <input type="text" class="form-control" id="tenMau" name="tenMau" placeholder="Nhập tên màu sắc"
                               required value="${mauSac.tenMau}">
                    </div>
                        ...
                        <div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" id="active" name="trangThai"
                                       value="Active" ${mauSac.trangThai == 'Active' ? 'checked' : ''} checked>
                                <label class="form-check-label" for="active">Active</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" id="inactive" name="trangThai"
                                       value="Inactive" ${mauSac.trangThai == 'Inactive' ? 'checked' : ''}>
                    ...
                    <div class="text-center">
                        <button formaction="/mau_sac/add" type="submit" class="btn btn-success">Thêm</button>
                        <button formaction="/mau_sac/update/${mauSac.id}" type="submit" class="btn btn-success">Sửa
                        </button>
                    </div>
                </form>
            </div>
            ...
            <table class="table table-striped table-bordered">
                ...
                <c:forEach items="${listMS}" var="mauSac" varStatus="s">
                    <tr>
                        ...
                        <td>
                            <a href="/mau_sac/delete/${mauSac.id}" class="btn btn-danger">Delete</button>
                            </a>
                            <a href="/mau_sac/detail/${mauSac.id}" class="btn btn-info">Detail</button>
                            </a>
                        </td>
                    </tr>
                </c:forEach>
