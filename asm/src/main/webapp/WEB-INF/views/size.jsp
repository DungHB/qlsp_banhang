            ...
            <div class="card-body">
                <form action="/size/add" method="post">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="maSize" name="maSize" placeholder="Nhập mã size"
                               required value="${size.maSize}">
                    </div>

                    <div class="form-group">
                        <label for="tenSize">Tên Size:</label>
                        <input type="text" class="form-control" id="tenSize" name="tenSize" placeholder="Nhập size"
                               required value="${size.tenSize}">
                    </div>
                        ...
                        <div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" id="active" name="trangThai"
                                       value="Active" ${size.trangThai == 'Active' ? 'checked' : ''} checked>
                                <label class="form-check-label" for="active">Active</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" id="inactive" name="trangThai"
                                       value="Inactive" ${size.trangThai == 'Inactive' ? 'checked' : ''}>
                                <label class="form-check-label" for="inactive">Inactive</label>
                            </div>
                        </div>
                    </div>
                    <div class="text-center">
                        <button formaction="/size/add" type="submit" class="btn btn-success">Thêm</button>
                        <button formaction="/size/update/${size.id}" type="submit" class="btn btn-success">Sửa</button>
                    </div>
                </form>
            </div>
        </div>
            ...
            <table class="table table-striped table-bordered">
                ...
                <c:forEach items="${listSize}" var="size" varStatus="s">
                    <tr>
                        ...
                        <td>${size.ngaySua}</td>
                        <td>
                            <a href="/size/delete/${size.id}" class="btn btn-danger">Delete</button>
                            </a>
                            <a href="/size/detail/${size.id}" class="btn btn-info">Detail</button>
                            </a>
                        </td>
                    </tr>
                </c:forEach>
